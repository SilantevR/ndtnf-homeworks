...
io.on('connection', (socket) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let book = yield book_1.default.findById(socket.handshake.query.roomName);
    socket.emit('show-comments', book.comments);
    socket.on('comment', (comment) => __awaiter(void 0, void 0, void 0, function* () {
        book = yield book_1.default.findByIdAndUpdate(socket.handshake.query.roomName, {
            $push: {
                comments: comment,
            },
...
const verify = (login, password, done) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield user_2.default.findOne({ login });
...
app.use('/', privatePage_1.default, index_1.default);
